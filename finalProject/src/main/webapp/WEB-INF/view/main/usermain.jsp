...
.cutter.chicken .default:hover {
	background-image: url('<%=cp%>/resource/img/chicken.gif');
}

@media only screen and (min-resolution:2dppx) {
	.cutter.chicken .cover {
		border-radius: 50%;
		background-image: url('<%=cp%>/resource/img/chickenBase.png');
...
.cutter.chinese .default:hover {
	background-image: url('<%=cp%>/resource/img/china.gif');
}

@media only screen and (min-resolution:2dppx) {
	.cutter.chinese .cover {
		border-radius: 50%;
		background-image: url('<%=cp%>/resource/img/china.jpg');
		width: 200px; height: auto;
		background-size: 200px 200px;
	}
...
.cutter.pizza .default:hover {
	background-image: url('<%=cp%>/resource/img/pizza.gif');
}

@media only screen and (min-resolution:2dppx) {
	.cutter.pizza .cover {
		border-radius: 50%;
		background-image: url('<%=cp%>/resource/img/pizza.jpg');
		width: 200px; height: auto;
		background-size: 200px 200px;
	}
...
.cutter.korean .default:hover {
	background-image: url('<%=cp%>/resource/img/bunsic.gif')
}

@media only screen and (min-resolution:2dppx) {
	.cutter.korean .cover {
		border-radius: 50%;
		background-image: url('<%=cp%>/resource/img/bunsic.jpg');
		width: 200px; height: auto;
		background-size: 200px 200px;
	}
...
.cutter.jokbal .default:hover {
	background-image: url('<%=cp%>/resource/img/bossam.gif')
}

@media only screen and (min-resolution:2dppx) {
	.cutter.jokbal .cover {
		border-radius: 50%;
		background-image: url('<%=cp%>/resource/img/bossam.png');
		width: 200px; height: auto;
		background-size: 200px 200px;
	}
...
.cutter.night .default:hover {
	background-image: url('<%=cp%>/resource/img/ya.gif');
}

@media only screen and (min-resolution:2dppx) {
	.cutter.night .cover {
		border-radius: 50%;
		background-image: url('<%=cp%>/resource/img/ya.jpg');
		width: 200px; height: auto;
		background-size: 200px 200px;
	}
...
.cutter.tang .default:hover {
	background-image: url('<%=cp%>/resource/img/zzim.gif')
}

@media only screen and (min-resolution:2dppx) {
	.cutter.tang .cover {
		border-radius: 50%;
		background-image: url('<%=cp%>/resource/img/zzim.jpg');
		width: 200px; height: auto;
		background-size: 200px 200px;
	}
	.cutter.tang .default {
...
.cutter.japanese .default:hover {
	background-image: url('<%=cp%>/resource/img/don.gif')
}

@media only screen and (min-resolution:2dppx) {
	.cutter.japanese .cover {
		border-radius: 50%;
		background-image: url('<%=cp%>/resource/img/don.jpg');
		width: 200px; height: auto;
		background-size: 200px 200px;
	}
