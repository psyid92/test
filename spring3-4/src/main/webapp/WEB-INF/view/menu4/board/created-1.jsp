...
<script type="text/javascript">
  function check() {
        ...
        var mode="${mode}";
    	if(mode=="created")
    		f.action="<%=cp%>/board/created";
     	else 	if(mode=="reply")
            f.action="<%=cp%>/board/reply";
    	else if(mode=="update")
    		f.action="<%=cp%>/board/update";
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="4" style="text-align: center; padding-top: 15px;">
                                  ...
                                  <button type="button" class="btn btn-danger" onclick="javascript:location.href='<%=cp%>/board/list';"> 취소 </button>
