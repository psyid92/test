...
<c:if test="${mode=='listSend'}">                        
                        ...
                        <th >내용</th>
                        <th class="text-center" style="width: 150px;">보낸날짜</th>
                        <th class="text-center" style="width: 150px;">확인날짜</th>
</c:if>                        
<c:if test="${mode=='listReceive'}">                        
                        <th class="text-center" style="width: 40px;">
                               <input type="checkbox" id="chkAll">
                        </th>
                        <th class="text-center" style="width: 100px;">보낸사람</th>
                        <th >내용</th>
                        <th class="text-center" style="width: 150px;">받은날짜</th>
                        <th class="text-center" style="width: 150px;">확인날짜</th>
</c:if>                        
                    </tr>
                </thead>
