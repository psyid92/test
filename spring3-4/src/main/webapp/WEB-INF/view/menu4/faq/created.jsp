...
<script type="text/javascript">
  function check() {
        ...
        var mode="${mode}";
    	if(mode=="created")
    		f.action="<%=cp%>/faq/created";
    	else if(mode=="update")
    		f.action="<%=cp%>/faq/update";
 ...
 function sendCategory() {
    	...
    	var url="<%=cp%>/faq/categoryCreated";
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="4" style="text-align: center; padding-top: 15px;">
                                  ...
                                  <button type="button" class="btn btn-danger" onclick="javascript:location.href='<%=cp%>/faq/faq?category=${category}';"> 취소 </button>
