...
<div>
    <div style="clear: both;">
         ...
         <div style="float: left; width: 140px;  padding: 0px 20px; line-height: 260px; height: 260px; text-align: ">
             <div class="btn-group-vertical" role="group" aria-label="Vertical button group">
             <button type="button" class="btn btn-default btn-sm" style="width: 100px;" id="noteRightMoveButton">&gt;</button>
             <button type="button" class="btn btn-default btn-sm" style="width: 100px;" id="noteRightAllMoveButton">&gt;&gt;</button>
             <button type="button" class="btn btn-default btn-sm" style="width: 100px;" id="noteLeftMoveButton">&lt;</button>
             <button type="button" class="btn btn-default btn-sm" style="width: 100px;" id="noteLeftAllMoveButton">&lt;&lt;</button>
             </div>
         </div>
         <div style="float: left; width: 220px;">
             <div style="clear: both; padding-bottom: 5px;">
    ...
    <div style="clear: both; max-width: 580px; padding-top:5px;">
        <div>
